  ...
  const gameCheck = (turn) => {
    if (
      ...
      (data.index4 === data.index5 &&
        data.index5 === data.index6 &&
        data.index6 !== 0) ||
      (data.index7 === data.index8 &&
        data.index8 === data.index9 &&
        data.index9 !== 0) ||
      (data.index1 === data.index3 &&
        data.index3 === data.index7 &&
        data.index7 !== 0) ||
      (data.index2 === data.index5 &&
        data.index5 === data.index8 &&
        data.index8 !== 0) ||
      (data.index3 === data.index6 &&
        data.index6 === data.index9 &&
        data.index9 !== 0) ||
      (data.index1 === data.index5 &&
        data.index5 === data.index9 &&
        data.index1 !== 0) ||
      (data.index3 === data.index5 &&
        data.index5 === data.index7 &&
        data.index7 !== 0)
    ) {
      setWinner(turn);
    }
    ...
    <div className="rowGap">
      <center>
        <div className="m-5">
          <div className="d-flex individualRow w-100">
            <div className="p-4 widthForDiv" onClick={onClickHandler} id="1">
              {data.index1 === 1 ? (
                <img src={Circle} width="50" alt="Circle" />
              ) : data.index1 === 2 ? (
                <img src={Cross} width="50" alt="Cross" />
              ) : (
                <img src={White} width="50" className="img" alt="Null" />
              )}
            </div>
        ...
        <div className="displayTurn mt-5 btn btn-outline-dark">
          {winner === 1 ? (
            <h1>Winner is {players.fPlayerName}</h1>
          ) : winner === 2 ? (
            <h1>Winner is {players.sPlayerName}</h1>
          ) : winner === 0 && count === 9 ? (
            <h1>Draw Match</h1>
          ) : (
